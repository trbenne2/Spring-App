...
/**
 * Service providing methods to work with user data entity
 * 
...
public class UserServiceImpl implements UserService, UserDetailsService{
	...
	public boolean checkAvailable(AjaxBehaviorEvent event) {
		...
		if(!available) {
			FacesMessage message = constructErrorMessage(null, String.format(getMessageBundle().getString("userExistsMsg"), value));  // use property file to hold all messages then that 
